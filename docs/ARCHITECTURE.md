...
| `/ws/monitor` | token | Autonomous cluster monitoring (27 scanners, auto-fix, investigations) |
...
│                                                        │
│  2. Run all 27 scanners (asyncio.to_thread each)       │
...
*156 tools (120 native + 36 MCP) -- 27 scanners -- 13 runbooks -- 83 PromQL recipes -- 192 eval scenarios -- 2,652 tests -- Protocol v2*