...
<p>
  <a href="https://github.com/alimobrem/pulse-agent/releases/tag/v1.11.0"><img src="https://img.shields.io/badge/release-v1.11.0-2563eb?style=for-the-badge" alt="Version"></a>
...
```bash
podman build --platform linux/amd64 -t quay.io/amobrem/pulse-agent:v1.11.0 -f Dockerfile.full .
podman push quay.io/amobrem/pulse-agent:v1.11.0
```
...
**Manual build:**
```bash
podman build --platform linux/amd64 -f Dockerfile.full -t quay.io/amobrem/pulse-agent:v1.11.0 .
podman push quay.io/amobrem/pulse-agent:v1.11.0
```
